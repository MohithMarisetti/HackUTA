...
import face_search_api as faceSearch
...
def takePic():
    ...
    return render_template('displayPic.html', path=src)
...
def showResults():
    ...
    '''
    result = []
    query = "SELECT * FROM hackuta.user_data;"
    cursor = connection.cursor()
    ...
    print(result)
    return render_template('showResults.html', path=src, res=result)
...
def upload_file():
    ...
    return render_template('displayPic.html', path=newsrc)
